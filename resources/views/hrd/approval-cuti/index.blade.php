    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <form method="GET" action="{{ route('hrd.approval-cuti.index') }}">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ \Illuminate\Support\Str::limit($cuti->alasan, 30) }}</td>
                            <td>
                            ...
                            <td>
                                <a href="{{ route('hrd.approval-cuti.show', $cuti->id) }}" class="btn btn-sm btn-info" title="Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </td>
                        </tr>
