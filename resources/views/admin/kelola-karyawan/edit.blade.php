                        ...
                        <select class="form-select @error('id_departemen') is-invalid @enderror" 
                            ...
                            @foreach($departemens as $departemen)
                                <option value="{{ $departemen->id }}" 
                                    {{ old('id_departemen', $karyawan->id_departemen) == $departemen->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_mulai_kerja') is-invalid @enderror" 
                               ...
                               value="{{ old('tanggal_mulai_kerja', $karyawan->tanggal_mulai_kerja ? $karyawan->tanggal_mulai_kerja->format('Y-m-d') : '') }}" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('peran') is-invalid @enderror" 
                            ...
                            <option value="karyawan" {{ old('peran', $karyawan->peran) == 'karyawan' ? 'selected' : '' }}>Karyawan</option>
                            <option value="hrd" {{ old('peran', $karyawan->peran) == 'hrd' ? 'selected' : '' }}>HRD</option>
                        </select>
                        @error('peran')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('sisa_cuti') is-invalid @enderror" 
                               id="sisa_cuti" name="sisa_cuti" value="{{ old('sisa_cuti', $karyawan->sisa_cuti) }}" min="0">
                        @error('sisa_cuti')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
